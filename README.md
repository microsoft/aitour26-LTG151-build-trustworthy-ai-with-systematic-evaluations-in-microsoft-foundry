...
## LTG151: Build trustworthy AI with systematic evaluations in Microsoft Foundry
...
- 2️⃣ | Check out the [session-delivery-sources](./session-delivery-resources/) & read the [Demo Guidance](./labs/README.md)
